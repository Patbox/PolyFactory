...
public record FluidInstance<T>(Holder<FluidType<T>> holder, T data) implements TypedInstance<FluidType<?>> {
    ...
    public FluidInstance(FluidType<T> type, T data) {
        this((Holder<FluidType<T>>) (Object) FactoryRegistries.FLUID_TYPES.wrapAsHolder(type), data);
    }
    ...
    @Override
    public int hashCode() {
        return System.identityHashCode(this.holder) + 31 * data.hashCode();
    }
