...
public class CopyColorLootFunction implements LootItemFunction {
    public static final CopyColorLootFunction INSTANCE = new CopyColorLootFunction();
    public static final MapCodec<CopyColorLootFunction> TYPE = MapCodec.unit(INSTANCE);
