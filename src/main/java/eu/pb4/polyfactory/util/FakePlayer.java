...
public class FakePlayer extends PlayerEntity {
    ...
    public FakePlayer(StackReference toolReference, World world, BlockPos pos, GameProfile gameProfile) {
        super(world, pos, 0, gameProfile);
    ...
    public class FakeInventory extends PlayerInventory {
        ...
        public ItemStack getMainHandStack() {
            return FakePlayer.this.toolReference.get();
        }
