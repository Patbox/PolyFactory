...
public record SimpleSpoutRecipe(CountedIngredient item, List<FluidStack<?>> fluidInput,
                                ItemStack output, boolean copyComponents, int itemDamage, RegistryEntry<SoundEvent> soundEvent, double time) implements SpoutRecipe {
    ...
    @Override
    public int damageInputItemAmount(SpoutInput input) {
