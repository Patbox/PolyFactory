...
public class RotationConstants {
    public static final float MAX_ROTATION_PER_TICK_1 = MathHelper.PI / 1f;
    public static final float MAX_ROTATION_PER_TICK_2 = MathHelper.PI / 2f;
    public static final float MAX_ROTATION_PER_TICK_3 = MathHelper.PI / 3f;
    public static final float MAX_ROTATION_PER_TICK_4 = MathHelper.PI / 4f;
