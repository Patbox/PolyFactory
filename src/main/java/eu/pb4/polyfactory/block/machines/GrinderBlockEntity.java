...
public class GrinderBlockEntity extends BlockEntity implements MinimalSidedInventory {
    ...
    private class Gui extends SimpleGui {
        public Gui(ServerPlayerEntity player) {
            ...
            this.setTitle(GrinderBlockEntity.this.getCachedState().getBlock().getName());
            var x= new GuiElementBuilder(Items.WHITE_STAINED_GLASS_PANE).setName(Text.empty());
            this.setSlot(0, x);
            this.setSlotRedirect(1, new Slot(GrinderBlockEntity.this, 0, 0, 0));
            this.setSlot(2, x);
            this.setSlot(3, x);
            this.setSlot(4, new GuiElementInterface() {
                ...
                public ItemStack getItemStack() {
                    return new GuiElementBuilder(Items.GOLDEN_PICKAXE)
                            .setName(Text.empty())
                            .hideFlags()
                            .setDamage(GrinderBlockEntity.this.currentRecipe != null
                                    ? Items.GOLDEN_PICKAXE.getMaxDamage() - (int) (MathHelper.clamp(GrinderBlockEntity.this.process / GrinderBlockEntity.this.currentRecipe.grindTime(), 0, 1) * Items.GOLDEN_PICKAXE.getMaxDamage())
                                    : Items.GOLDEN_PICKAXE.getMaxDamage()
                            ).asStack();
                }
            });
            this.setSlot(5, x);
            this.setSlotRedirect(6, new FurnaceOutputSlot(player, GrinderBlockEntity.this, 1, 1, 0));
            this.setSlotRedirect(7, new FurnaceOutputSlot(player, GrinderBlockEntity.this, 2, 2, 0));
            this.setSlotRedirect(8, new FurnaceOutputSlot(player, GrinderBlockEntity.this, 3, 3, 0));
