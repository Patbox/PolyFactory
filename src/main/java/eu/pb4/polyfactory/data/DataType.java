...
public record DataType<T extends DataContainer>(String id, MapCodec<T> codec, List<String> fields) implements StringIdentifiable {
    ...
    public static final DataType<BlockStateData> BLOCK_STATE = new DataType<>("block_state", BlockStateData.TYPE_CODEC, "type");
    public static final DataType<ItemStackData> ITEM_STACK = new DataType<>("item_stack", ItemStackData.TYPE_CODEC, "type", "count", "name");
    public static final DataType<CapacityData> CAPACITY = new DataType<>("capacity", CapacityData.TYPE_CODEC, "stored", "capacity");
